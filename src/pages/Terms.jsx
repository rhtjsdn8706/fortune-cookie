...
export default function Terms() {
  return (
    <ContentPage title="이용약관">
      ...
      <section>
        <h2 className="text-lg font-semibold text-text-main mb-3">제1조 (목적)</h2>
        <p>
      ...
      <section>
        <h2 className="text-lg font-semibold text-text-main mb-3">제2조 (서비스의 내용)</h2>
        <p>
          서비스는 이용자가 입력한 생년월일과 10개 문항의 설문 응답을 기반으로
          오락 목적의 운세 결과를 생성하여 제공합니다.
          서비스의 모든 결과는 <strong className="text-text-main">엔터테인먼트 콘텐츠</strong>이며,
          과학적·학술적 근거에 기반하지 않습니다.
        </p>
      </section>

      <section>
        <h2 className="text-lg font-semibold text-text-main mb-3">제3조 (면책 조항)</h2>
      ...
      <section>
        <h2 className="text-lg font-semibold text-text-main mb-3">제4조 (지적재산권)</h2>
        <p>
      ...
      <section>
        <h2 className="text-lg font-semibold text-text-main mb-3">제5조 (서비스의 변경 및 중단)</h2>
        <p>
      ...
      <section>
        <h2 className="text-lg font-semibold text-text-main mb-3">제6조 (이용자의 의무)</h2>
        <ol className="list-decimal list-inside space-y-2">
      ...
      <section>
        <h2 className="text-lg font-semibold text-text-main mb-3">제7조 (준거법 및 관할)</h2>
        <p>
      ...
      <section>
        <h2 className="text-lg font-semibold text-text-main mb-3">부칙</h2>
